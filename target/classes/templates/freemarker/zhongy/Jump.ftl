...
<head>
    ...
    <meta http-equiv="refresh" content="1;url='${view!'啥也没有'}';">
    <title>转一圈</title>
    <div id="circle"></div>
    ...
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta http-equiv="refresh" content="1;url='${view!'/adlogin'}';">
        <title>${msg!'三秒后跳转'}</title>
        <style>
            <style type="text/css">
...
<body>
<div id="loader-container"><p id="loadingText">${msg!'三秒后跳转'}</p></div>
</body>
</html>