          ...
          <#else>
            <#list cates as catei_tem>
                ...
                <tr>
                    ...
                    <td><DIV class="button-group"> <a class="button border-main" href="cateedit.ftl"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return del(1,2)"><span class="icon-trash-o"></span> 删除</a> </DIV></td>
                </tr>
            </#list>
        </#if>
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <textarea type="text" class="input w50" name="tits" style="height:150px;"
                              placeholder="多个分类标题请转行"></textarea>
